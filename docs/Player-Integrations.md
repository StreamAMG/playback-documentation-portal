...
- <b>Resume Capability</b> (allow playback from saved/last watched positions in videos across devices) — [Resume hub](./resume/Resume-Playback-External-Bitmovin.md), [VoD](./resume/Resume-Playback-External-Bitmovin-VoD.md), [Live](./resume/Resume-Playback-External-Bitmovin-Live.md), and **Playback Resume API** in the portal.
